...
class Song {
  ...
  factory Song.fromMap(Map<String, dynamic> map) {
    return Song(
      ...
      albumArt:
          map['album_art'] ??
          map['albumArt'], // on_audio_query uses 'album_art'
      ...
      dateAdded:
          map['date_added'] !=
              null // on_audio_query uses 'date_added'
      ...
      dateModified:
          map['date_modified'] !=
              null // on_audio_query uses 'date_modified'
          ? DateTime.fromMillisecondsSinceEpoch(map['date_modified'] * 1000)
          : (map['dateModified'] != null
                ? DateTime.fromMillisecondsSinceEpoch(map['dateModified'])
                : null),
